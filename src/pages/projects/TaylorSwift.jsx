                    ...
                    <div
                        ...
                        <div>
                            <p><span className={"text-accent"}>✦</span> Het project is gemaakt
                                in het eerste jaar CMGT aan Hogeschool Rotterdam voor het vak Front-end
                                Development,
                                waarbij ik werkte met HTML en CSS.</p>
                        </div>

                        <div>
                            <h2 className={"text-2xl sm:text-3xl"}>Inzichten</h2>
                            <p><span className={"text-accent"}>✦</span> Semantische HTML tags gebruiken voor
                                structuur en SEO.</p>
                            ...
                            <p><span className={"text-accent"}>✦</span>HTML formulier met validatie gemaakt.</p>
                        </div>
